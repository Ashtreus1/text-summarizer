    ...
    <div class="flex justify-center items-center h-screen">
        <div class="w-full max-w-lg p-6 bg-white shadow-md rounded-lg">
            ...
            <div class="relative border border-dashed border-gray-300 rounded-lg p-6">
                <form method="POST" action="/summarizer" class="space-y-4">
                    @csrf
                    <div class="flex items-center justify-center h-32 border-dashed border-2 border-gray-400 rounded-lg cursor-pointer">
                    ...
                    <textarea name="paragraph" rows="6" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Or enter your text here..."></textarea>
                    <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 rounded-lg transition duration-300">Summarize</button>
                </form>
            </div>
        </div>
    </div>
